...
-(void)setUpAllChildViewController{
    _VCS = @[].mutableCopy;
    GTHomeViewController *homeVC = [[GTHomeViewController alloc]init];
    ...
    GTHomeViewController *makeFriendVC = [[GTHomeViewController alloc]init];
    [self setupChildViewController:makeFriendVC title:@"dd" imageName:@"icon_tabbar_onsite" seleceImageName:@"icon_tabbar_onsite_selected"];
    
//    MsgViewController *msgVC = [[MsgViewController alloc]init];
    GTHomeViewController *msgVC = [GTHomeViewController new];
    ...
    GTHomeViewController *mineVC = [[GTHomeViewController alloc]init];
